    ...
    return (
        <>
            <Routes>
                ...
                <Route path="form-endereco" element={ <ProtectedRoute> <FormEnderecos/> </ProtectedRoute> } />
                <Route path="list-endereco" element={ <ProtectedRoute> <ListEnderecos/> </ProtectedRoute> } />
            </Routes>
        </>
    )
}
